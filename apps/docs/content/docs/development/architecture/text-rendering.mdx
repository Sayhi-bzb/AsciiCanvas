...
The [`chardesk` CLI](../../../../../../packages/cli/README.md) is a headless host of the same
...
painter with vendored fonts on Node Canvas. ANSI serialization is an explicit output backend, never
