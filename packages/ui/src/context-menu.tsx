    ...
    <ContextMenuPrimitive.Portal>
      <ContextMenuPrimitive.SubContent
        ...
        className={cn(
          ...
          rx.overlayMotion,
          rx.portalLayer({ modal: portalLayer === 'modal' }),
          'text-popover-foreground data-[side=bottom]:slide-in-from-top-1 data-[side=left]:slide-in-from-right-1 data-[side=right]:slide-in-from-left-1 data-[side=top]:slide-in-from-bottom-1 min-w-[8rem] origin-(--radix-context-menu-content-transform-origin) overflow-hidden p-1',
          className
        )}
        {...props}
      />
