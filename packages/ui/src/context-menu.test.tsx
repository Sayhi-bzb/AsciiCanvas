...
describe('ContextMenu styling', () => {
  it('uses muted borderless surfaces for root and sub menus', async () => {
    ...
    expect(screen.getByText('Action')).toHaveClass('min-h-7', 'rounded-item', 'px-2', 'text-xs');
    ...
    expect(rootMenu.className).not.toContain('slide-in-from-left-2');
    expect(screen.getByRole('separator')).toHaveClass('h-0.5', 'rounded-full', 'bg-separator');
