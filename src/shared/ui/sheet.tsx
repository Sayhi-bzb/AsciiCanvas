  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          "bg-dialog-surface data-[state=open]:animate-in data-[state=closed]:animate-out fixed z-[100] flex flex-col gap-4 border-0 shadow-dialog transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500",
          side === "right" &&
